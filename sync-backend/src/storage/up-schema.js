const UP_SCHEMA_VERSION = 8;
const UP_SCHEMA_MIGRATION = [8, 'up_portrait_collector'];

const UP_TABLE_STATEMENTS = [
...
const UP_COLUMNS = [
  ['up_targets', 'name', "text not null default ''"],
  ['up_targets', 'seed_source', "text not null default ''"],
  ['up_targets', 'seed_bvid', "text not null default ''"],
  ['up_targets', 'note', "text not null default ''"],
  ['up_targets', 'status', "text not null default 'pending'"],
  ['up_targets', 'priority', 'integer not null default 0'],
  ['up_targets', 'last_collected_at', "text not null default ''"],
  ['up_targets', 'next_collect_after', "text not null default ''"],
  ['up_targets', 'last_error_type', "text not null default ''"],
  ['up_targets', 'last_error_message', "text not null default ''"],
  ['up_targets', 'failure_count', 'integer not null default 0']
];
